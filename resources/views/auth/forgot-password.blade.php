...
<head>
    ...
    <title>Forgot Password - CSPC Report Concern</title>
    ...
    <style>
        :root{--navy:#0D1B3E;--gold:#f4c430;--brand:#2f5bea;--brand6:#2347c4;--brand50:#eef2ff;
            ...
            --success-bg:#e7f8ee;--success-ink:#137a3f}
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .alert-success{background:var(--success-bg);color:var(--success-ink);border:1px solid #bfe9cf;
            padding:.85rem 1rem;border-radius:11px;margin-bottom:1.3rem;font-size:.9rem}
                ...
                <form action="{{ route('password.email') }}" method="POST">
                    ...
                    <div class="fg">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                               placeholder="you@cspc.edu" required autofocus>
                    </div>
